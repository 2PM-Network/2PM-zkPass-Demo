...
// export function checkTaskInfoForSolana(task, schema, validatorAddress, signature) {
...
export function checkTaskInfoForEVM(task, schema, validatorAddress, signature) {
  const web3 = new Web3();
